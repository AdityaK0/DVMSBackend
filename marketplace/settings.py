...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(hours=5),  # Reduced from 10 hours for security
...
CORS_ALLOWED_ORIGINS=["https://49c782eb.fordgeindia-admin-frontend.pages.dev","https://d2pwo63dqka82f.cloudfront.net","http://localhost:5173","https://admin.fordgeindia.online","https://www.admin.fordgeindia.online"]
